...
public class OperadoresRelacionais {
	...
	public static void main(String[] args) {
		...
		System.out.println("s1 != s2 " + (s1 != s2));
		//Exemplo de comparação de tamanho que não se aplica a String:
//		System.out.println(s1 >= s2);
//		System.out.println(s1 < s2);
		
		System.out.println("b1 == b2 " + (b1 == b2));
		System.out.println("b1 != b2 " + (b1 != b2));
		//Exemplo de comparação de tamanho que não se aplica a boolean:
//		System.out.println(b1 > b2);
//		System.out.println(b1 <= i1);
		
		System.out.println("i2 > f1 " + (i2 > f1));
		System.out.println("d1 == h1 " + (d1 == h1));
		//Tipo de operador que não consegue comparar com esses dados:
